...
* Follow the below instructions for setting up a Discord or Slack bot (or even both!). Be sure to complete the [final steps](https://github.com/EthyMoney/Adafruit-Pi4-Stock-Bot#final-configuration-steps-and-bot-startup) as well once you finish the Discord and Slack specific instructions.
